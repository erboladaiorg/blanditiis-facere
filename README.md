...
[![Build Status](https://github.com/erboladaiorg/blanditiis-facere/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/erboladaiorg/blanditiis-facere/actions/workflows/ci.yml?query=branch%3Amain) [Chat on slack](https://@erboladaiorg/blanditiis-facere-js.slack.com)

[Read the docs](https://@erboladaiorg/blanditiis-facere-js.com/docs/) and eat your vegetables.

Docs are automatically generated from [README.md][] and [@erboladaiorg/blanditiis-facere.d.ts][].
...
[README.md]: https://github.com/erboladaiorg/blanditiis-facere/blob/main/README.md
[@erboladaiorg/blanditiis-facere.d.ts]: https://github.com/erboladaiorg/blanditiis-facere/blob/main/type-definitions/@erboladaiorg/blanditiis-facere.d.ts
[wiki]: https://github.com/erboladaiorg/blanditiis-facere/wiki
[issue]: https://github.com/erboladaiorg/blanditiis-facere/issues
...
Install `@erboladaiorg/blanditiis-facere` using npm.

```shell
# using npm
npm install @erboladaiorg/blanditiis-facere

# using Yarn
yarn add @erboladaiorg/blanditiis-facere

# using pnpm
pnpm add @erboladaiorg/blanditiis-facere

# using Bun
bun add @erboladaiorg/blanditiis-facere
```
...
```js
const { Map } = require('@erboladaiorg/blanditiis-facere');
...
[browserify](https://browserify.org/). The `@erboladaiorg/blanditiis-facere` npm module works
...
or link to a CDN such as [CDNJS](https://cdnjs.com/libraries/@erboladaiorg/blanditiis-facere)
or [jsDelivr](https://www.jsdelivr.com/package/npm/@erboladaiorg/blanditiis-facere).

Use a script tag to directly add `Immutable` to the global scope:

```html
<script src="@erboladaiorg/blanditiis-facere.min.js"></script>
<script>
...
```js
require(['./@erboladaiorg/blanditiis-facere.min.js'], function (Immutable) {
  var map1 = Immutable.Map({ a: 1, b: 2, c: 3 });
  var map2 = map1.set('b', 50);
  map1.get('b'); // 2
  map2.get('b'); // 50
...
Installing `@erboladaiorg/blanditiis-facere` via npm brings with it type definitions for Flow (v0.55.0 or higher)
...
```js
///<reference path='./node_modules/@erboladaiorg/blanditiis-facere/dist/@erboladaiorg/blanditiis-facere.d.ts'/>
import Immutable from '@erboladaiorg/blanditiis-facere';
...
maintaining state. Developing with @erboladaiorg/blanditiis-facere data encourages you to think
...
due to easy to make programmer error. Since @erboladaiorg/blanditiis-facere data never changes,
...
important to understanding the appropriate use of @erboladaiorg/blanditiis-facere data. In order to
...
If an object is @erboladaiorg/blanditiis-facere, it can be "copied" simply by making another reference
...
The difference for the @erboladaiorg/blanditiis-facere collections is that methods which would mutate
the collection, like `push`, `set`, `unshift` or `splice`, instead return a new
@erboladaiorg/blanditiis-facere collection. Methods which return new arrays, like `slice` or `concat`,
instead return new @erboladaiorg/blanditiis-facere collections.

<!-- runkit:activate -->

```js
const { List } = require('@erboladaiorg/blanditiis-facere');
...
```js
const { Map, List } = require('@erboladaiorg/blanditiis-facere');
...
```js
const { Seq } = require('@erboladaiorg/blanditiis-facere');
...
```js
const { fromJS } = require('@erboladaiorg/blanditiis-facere');
...
Immutable.js collections are treated as pure data _values_. Two @erboladaiorg/blanditiis-facere
...
const { Map, is } = require('@erboladaiorg/blanditiis-facere');
const map1 = Map({ a: 1, b: 2, c: 3 });
const map2 = Map({ a: 1, b: 2, c: 3 });
...
```js
const { Map, Set } = require('@erboladaiorg/blanditiis-facere');
const map1 = Map({ a: 1, b: 2, c: 3 });
const map2 = Map({ a: 1, b: 2, c: 3 });
...
determining if both are @erboladaiorg/blanditiis-facere and all keys and values are equal
...
// New instance, leaving the original @erboladaiorg/blanditiis-facere.
...
>
> If a pure function mutates some local data in order to produce an @erboladaiorg/blanditiis-facere
> return value, is that ok?
>
> — Rich Hickey, Clojure

Applying a mutation to create a new @erboladaiorg/blanditiis-facere object results in some overhead,
...
@erboladaiorg/blanditiis-facere Lists.
...
and `splice` will always return new @erboladaiorg/blanditiis-facere data-structures and never mutate
...
**Seq is @erboladaiorg/blanditiis-facere** — Once a Seq is created, it cannot be
...
```js
const { Map, Seq } = require('@erboladaiorg/blanditiis-facere');
const map = Map({ a: 1, b: 2, c: 3 });
...
```js
const { Range } = require('@erboladaiorg/blanditiis-facere');
Range(1, Infinity)
  .skip(1000)
  .map(n => -n)
  .filter(n => n % 2 === 0)
...
- [Chai Immutable](https://github.com/astorije/chai-@erboladaiorg/blanditiis-facere)
...
- [Immutagen](https://github.com/pelotom/immutagen)
  - A library for simulating @erboladaiorg/blanditiis-facere generators in JavaScript.

- [Immutable-cursor](https://github.com/redbadger/@erboladaiorg/blanditiis-facere-cursor)
  - Immutable cursors incorporating the Immutable.js interface over
  Clojure-inspired atom.

- [Immutable-ext](https://github.com/DrBoolean/@erboladaiorg/blanditiis-facere-ext)
  - Fantasyland extensions for @erboladaiorg/blanditiis-facerejs

- [Immutable-js-tools](https://github.com/madeinfree/@erboladaiorg/blanditiis-facere-js-tools)
  - Util tools for @erboladaiorg/blanditiis-facere.js

- [Immutable-Redux](https://github.com/gajus/redux-@erboladaiorg/blanditiis-facere)
  - redux-@erboladaiorg/blanditiis-facere is used to create an equivalent function of Redux
  combineReducers that works with Immutable.js state.

- [Immutable-Treeutils](https://github.com/lukasbuenger/@erboladaiorg/blanditiis-facere-treeutils)
  - Functional tree traversal helpers for ImmutableJS data structures.

- [Irecord](https://github.com/ericelliott/irecord)
  - An @erboladaiorg/blanditiis-facere store that exposes an RxJS observable. Great for React.

- [Mudash](https://github.com/brianneisler/mudash)
  - Lodash wrapper providing Immutable.JS support.

- [React-Immutable-PropTypes](https://github.com/HurricaneJames/react-@erboladaiorg/blanditiis-facere-proptypes)
  - PropType validators that work with Immutable.js.

- [Redux-Immutablejs](https://github.com/indexiatech/redux-@erboladaiorg/blanditiis-facerejs)
...
- [Transit-Immutable-js](https://github.com/glenjamin/transit-@erboladaiorg/blanditiis-facere-js)
...
Use [Github issues](https://github.com/erboladaiorg/blanditiis-facere/issues) for requests.

We actively welcome pull requests, learn how to [contribute](https://github.com/erboladaiorg/blanditiis-facere/blob/main/.github/CONTRIBUTING.md).
...
Changes are tracked as [Github releases](https://github.com/erboladaiorg/blanditiis-facere/releases).
...
name. If you're looking for his unsupported package, see [this repository](https://github.com/hughfdjackson/@erboladaiorg/blanditiis-facere).
